...
ggplot() + 
  ...
  geom_line(data=???, aes(x=Date, y=TeamFGPCT), color="dark green") +
  scale_y_continuous(limits = c(0, .7))
```
...
ggplot() + 
  ...
  geom_line(data=msu, aes(x=Date, y=TeamFGPCT), color="dark green") +
  scale_y_continuous(limits = c(0, .7))
```
```{r line3-check}
grade_this_code()
...
ggplot() + 
  geom_line(data=???, aes(x=Date, y=TeamFGPCT), color="????") +
  geom_line(data=??, aes(x=Date, y=TeamFGPCT), color="red") + 
  geom_line(data=???, aes(x=Date, y=TeamFGPCT), color="dark green") +
  scale_y_continuous(limits = c(0, .7))
```
...
ggplot() + 
  geom_line(data=big, aes(x=Date, y=TeamFGPCT), color="grey") +
  geom_line(data=nu, aes(x=Date, y=TeamFGPCT), color="red") + 
  geom_line(data=msu, aes(x=Date, y=TeamFGPCT), color="dark green") +
  scale_y_continuous(limits = c(0, .7))
```
