...
bigwbb <- load_wbb_team_box(seasons = 2023) %>% 
...
bigwbb %>% 
  ...
  tab_header(
    ...
    ???????? = "Amy Williams' team is near the bottom of a tough conference where it matters most."
  )
```
...
bigwbb %>% 
  ...
  tab_header(
    ...
    subtitle = "Amy Williams' team is near the bottom of a tough conference where it matters most."
  )
```
```{r table2-check}
grade_this_code()
