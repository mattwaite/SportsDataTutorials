...
This is another extension to ggplot. You installed it at the beginning of the semester, but if you need it, you'll install it with: `devtools::install_github("mattwaite/ggbump")`
...
Let's use college football playoff rankings, specifically the top 12 in each week of the rankings. 

```{r bump-load-data, message=FALSE, warning=FALSE}
rankings <- read_csv("https://mattwaite.github.io/sportsdatafiles/cfbranking25.csv")
```
...
ggplot() + 
  ...
  scale_y_reverse() +
  labs(title="The top stays top", subtitle="The CFB playoff picture hasn't changed with Oregon first, but below them there's movement.", y= "Rank", x = "Week") +
  theme_minimal() +
  theme(
