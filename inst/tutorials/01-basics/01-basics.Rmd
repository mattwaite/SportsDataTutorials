...
[You can find season stats here](https://huskers.com/sports/baseball/stats/season/2026) at the bottom of the table in a row labeled Totals. The number of games is in the column named GP, which stands for Games Played. See why naming things what they are is a rule in this class?
...
*Write the code necessary to create the variables and set it to the number of home runs Nebraska hit in the 2026 season and the number of games played. Then, divide those two variables to get the home runs per game.*
