...
[You can find season stats here](https://huskers.com/sports/baseball/stats/2022) at the bottom of the table in a row labeled Totals. The number of games is in the column named GP-GS, which stands for Games Played - Games Started. See why naming things what they are is a rule in this class?
...
Using some rounding, the Huskers hit .96 home runs per game this past season. So if you watched a game, chances are you were going to see the Good Guys hit at least one bomb. Some days you get zero, some days you get more than one, but on average, they hit just about 1 per game. 
