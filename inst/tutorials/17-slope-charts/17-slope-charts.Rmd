...
Think of a slope chart like the meme you see online: How is started vs how it's going. For example, did you know Nebraska had the second most explosive offense in the Big Ten in 2021? 

It's true. I'll show you. But what happened in 2022?

You're going to need a dataset I created that has two seasons of Yards Per Play data on offense. This is the total yards gained divided by the total number of plays. For each team, there's two rows -- one in 2021 and one in 2022. 
...
dllink <- download_link(
  link = "http://mattwaite.github.io/sportsdatafiles/footballslope.csv",
...
yardsperplay <- read_csv("http://mattwaite.github.io/sportsdatafiles/footballslope.csv")
...
ggplot() + 
  geom_line(data=big, aes(x=Season, y=YardsPerPlay, group=Team), color="grey") +
  geom_point(data=big, aes(x=Season, y=YardsPerPlay, group=Team), color="grey") +
  geom_line(data=??, aes(x=Season, y=YardsPerPlay, group=Team), color="red") +
  geom_point(data=??, aes(x=Season, y=YardsPerPlay, group=Team), color="red") +
...
ggplot() + 
  ...
  geom_line(data=mi, aes(x=Season, y=YardsPerPlay, group=Team), color="blue") +
  geom_point(data=mi, aes(x=Season, y=YardsPerPlay, group=Team), color="blue") + 
  scale_x_continuous(breaks=c(????, ????), limits=c(2020.5,2022.5)) 
```
