...
Let's look at Fred Hoiberg's current season. **For purposes of this exercise, you don't need to do this. The data is included here if you want to try this in your own notebook.**
...
dllink <- download_link(
  link = "https://mattwaite.github.io/sportsdatafiles/logs24.csv",
