...
Let's let arrange help us. Remember, if you have group_by, then what is in arrange comes from a name you created in summarize. In this case, we don't have group_by, so what goes in arrange is just the field name. Let's put this in order of minutes played.

```{r group-by-5, exercise=TRUE, exercise.setup = "load-data"}
nbaplayers %>% arrange(desc(??))
```
...
### Exercise 8: Even more aggregatess
