...
dllink <- download_link(
  link = "http://mattwaite.github.io/sportsdatafiles/ncaa_womens_soccer_totals_2021.csv",
...
soccer <- read_csv("http://mattwaite.github.io/sportsdatafiles/ncaa_womens_soccer_totals_2021.csv")
...
glue("What conference do you not want to be a keeper?  The {confsnipers$Institution} Conference, who are on goal {format(confsnipers$SoGPct, digits=1)}% of the time.")
``` 