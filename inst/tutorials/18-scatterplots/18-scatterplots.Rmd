...
dllink <- download_link(
  link = "https://mattwaite.github.io/sportsdatafiles/ncaa_womens_volleyball_playerstats_2022.csv",
...
players <- read_csv("https://mattwaite.github.io/sportsdatafiles/ncaa_womens_volleyball_playerstats_2022.csv")
...
Normally, we'd stop here, but let's look at the third element: The coefficient. In this case, the coefficient for height is 21.9140. What this model predicts, given that and the intercept of -1410.6429, is this: Every player starts about 1410 kills in the hole. For every inch they grow, they get 21 kills. Remember your algebra and y = mx + b. In this case, y is the wins, m is the coefficient, x is the number of threes given up and b is the intercept. 

Let's use Madi Kubik as an example. She's 6'3" on the roster, or 75 inches.  

y = 21.9140 * 75 - 1410.6429 or 233 kills. 

How many wins did Kubik have last seaon? 339. 

If we built a model to predict kills based purely on height, we missed Kubik's actual results by more than 100. Not great. 
