...
options(tutorial.storage = filesystem_storage("~"))
```
...
```{r variables-one, exercise=TRUE, exercise.reveal_solution = FALSE}
...
*Each interactive exercise will include a quiz to make sure you do what your generation views as a violation of the Geneva Convention: read.*

```{r quiz}
quiz(
  question("Overlooking simple mistakes makes you ...",
    answer("dumb"),
    answer("really dumb"),
    answer("just really stupid"),
    answer("like everyone else, including your professor", correct = TRUE),
    incorrect = "Incorrect. Everyone, and I mean EVERYONE, misses the little stuff, especially when you're learning."
  ),
  question("The * symbol means",
    answer("multiplication", correct = TRUE),
    answer("division"),
    answer("addition"),
    answer("subtraction"),
    incorrect = "Incorrect. The * means mulitiplication."
  ),
  question("The order that your code is executed in does not matter.",
    answer("true"),
    answer("false", correct = TRUE),
    incorrect = "Incorrect. It very much matters."
  ),
  question("The <- symbol is called",
    answer("the spear"),
    answer("the variable creator"),
    answer("the pointy thingy"),
    answer("the assignment operator", correct = TRUE),
    incorrect = "Incorrect. We might sometimes call it the arror, but it's real name is the assignment operator."
  ),
  question("This assigns a number value of 10 to a variable called Score: `Score <- \"10\"`.",
    answer("true"),
    answer("false", correct = TRUE),
    incorrect = "Incorrect. Note the quote marks around the 10. Those quote marks make the 10 a string, which isn't a number."
  ),
  question("According to the 5 Rules for Naming Variables, naming a variable K that will hold the number of strikeouts a team had is fine.",
    answer("true"),
    answer("false", correct = TRUE),
    incorrect = "Incorrect. Even though seamheads will know that a strikeout is a K in the scorebook, you should never name variables with one letter."
  ) 
)
```