---
title: "Sports Data Lesson 25: Encirlcing points"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
dllink <- download_link(
  link = "http://mattwaite.github.io/sportsdatafiles/players23.csv",
...
players <- read_csv("http://mattwaite.github.io/sportsdatafiles/players23.csv") %>% filter(MP > 100 & TRB > 0)

nu <- players %>% filter(Team == "Nebraska")

dw <- nu %>% filter(Player == "Derrick Walker")
```
```{r encircle-load-data-exercise, exercise = TRUE}
players <- read_csv("http://mattwaite.github.io/sportsdatafiles/players23.csv") %>%
  filter(MP > 100 & TRB > 0)
```
