---
title: "Lesson 30: Finishing touches"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
Let's explore fixing up ggplot's output. We'll need a graphic to work with first, so I'm going to use the bubble chart we just worked with in the last lesson. 
...
**NOTE**: Theming is something you do last. And if you're going to change theme elements, you need to apply your prepackaged theme first, then do your theme customization. Everything in ggplot is rendered in order. If you do custom theming, THEN apply the prepackaged theme, the prepackaged theme will overwrite anything you did. So theme_minimal comes first.
