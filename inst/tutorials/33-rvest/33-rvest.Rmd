...
Let's grab [a simple, basic HTML table from College Football Stats](https://cfbstats.com/2023/leader/national/team/offense/split01/category09/sort01.html). There's nothing particularly strange about this table -- it's simply formatted and easy to scrape. 
...
scoringoffenseurl <- "https://cfbstats.com/2023/leader/national/team/offense/split01/category09/sort01.html"
...
scoringoffenseurl22 <- "https://cfbstats.com/2022/leader/national/team/offense/split01/category09/sort01.html"
...
scoringoffense2022 <- scoringoffense22[[1]]

fixedscoringoffense2022 <- scoringoffense2022 |> rename(Rank = 1)|> mutate(YEAR = 2022)
fixedscoringoffense2023 <- scoring |> rename(Rank = 1) |> mutate(YEAR = 2023)

combined <- bind_rows(fixedscoringoffense2022, fixedscoringoffense2022)
...
fixedscoringoffense2022 <- scoringoffense2022 |> rename(Rank = 1) |> mutate(YEAR = ____)
fixedscoringoffense2023 <- scoring |> rename(Rank = 1) |> mutate(YEAR = ____)
```
...
combined <- bind_rows(____2022, ____2023)
```
```{r rvest4-solution, exercise.reveal_solution = FALSE}
combined <- bind_rows(fixedscoringoffense2022, fixedscoringoffense2023)
```
```{r rvest4-check}
grade_this_code()
```
